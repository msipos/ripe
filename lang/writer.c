...
const char* wr_dump(const char* module_name)
{
  ...
  sbuf_printf(&sb, "void init1a_%s(void);\n", module_name);
  sbuf_printf(&sb, "void init1b_%s(void);\n", module_name);
  sbuf_printf(&sb, "void init2_%s(void);\n", module_name);
  sbuf_printf(&sb, "void init3_%s(void);\n", module_name);

  sbuf_printf(&sb, "#line 1 \"Ripe Header\"\n");
  sbuf_printf(&sb, "%s", sb_header->str);
  sbuf_printf(&sb, "#line 1 \"Ripe Code\"\n");
  sbuf_printf(&sb, "%s", sb_contents->str);

  sbuf_printf(&sb, "#line 1 \"Ripe Init 1 A\"\n");
  sbuf_printf(&sb, "void init1a_%s(void){\n", module_name);
  sbuf_printf(&sb, "%s", sb_init1a->str);
  sbuf_printf(&sb, "}\n");

  sbuf_printf(&sb, "#line 1 \"Ripe Init 1 B\"\n");
  sbuf_printf(&sb, "void init1b_%s(void){\n", module_name);
  sbuf_printf(&sb, "%s", sb_init1b->str);
  sbuf_printf(&sb, "}\n");

  sbuf_printf(&sb, "#line 1 \"Ripe Init 2\"\n");
  sbuf_printf(&sb, "void init2_%s(void){\n", module_name);
  sbuf_printf(&sb, "%s", sb_init2->str);
  sbuf_printf(&sb, "}\n");

  sbuf_printf(&sb, "#line 1 \"Ripe Init 3\"\n");
  sbuf_printf(&sb, "void init3_%s(void){\n", module_name);
